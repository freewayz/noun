...
},{"react/lib/ExecutionEnvironment":62,"react/lib/invariant":177}],11:[function(require,module,exports){
/* jshint -W084 */
'use strict';
...
},{"object-assign":42,"qs":4,"react/lib/invariant":177}],14:[function(require,module,exports){
'use strict';
...
},{"./Route":16,"react":197,"react/lib/Object.assign":68}],15:[function(require,module,exports){
/**
...
},{"./PathUtils":13,"react/lib/Object.assign":68,"react/lib/invariant":177,"react/lib/warning":196}],17:[function(require,module,exports){
'use strict';
...
},{"./getWindowScrollPosition":32,"react/lib/ExecutionEnvironment":62,"react/lib/invariant":177}],18:[function(require,module,exports){
'use strict';
...
module.exports = Link;
},{"../PropTypes":14,"react":197,"react/lib/Object.assign":68}],26:[function(require,module,exports){
'use strict';
...
module.exports = Route;
},{"../PropTypes":14,"./RouteHandler":29,"react":197,"react/lib/invariant":177}],29:[function(require,module,exports){
'use strict';
...
},{"../PropTypes":14,"./ContextWrapper":23,"react":197,"react/lib/Object.assign":68}],30:[function(require,module,exports){
(function (process){
/* jshint -W058 */
'use strict';
...
},{"./Route":16,"./components/DefaultRoute":24,"./components/NotFoundRoute":26,"./components/Redirect":27,"react":197,"react/lib/Object.assign":68,"react/lib/warning":196}],32:[function(require,module,exports){
'use strict';
...
},{"react/lib/ExecutionEnvironment":62,"react/lib/invariant":177}],33:[function(require,module,exports){
'use strict';
...
},{"react":197}],35:[function(require,module,exports){
'use strict';
...
},{"react/lib/invariant":177}],39:[function(require,module,exports){
'use strict';
...
},{"../History":10,"../actions/LocationActions":20,"react/lib/invariant":177}],40:[function(require,module,exports){
'use strict';
        ...
        return (
            React.createElement("div", {className: "file-field input-field"}, 
                ...
                React.createElement("div", {className: "file-path-wrapper"}, 
                    React.createElement("input", {className: "file-path validate", type: "text", placeholder: "Upload Resource file"})
                )
            )
        );
    }
      ...
      formContent = (
        React.createElement("div", null, 
          React.createElement("p", null, 
            "You're logged in as ", React.createElement("strong", null,  this.state.user.name), "."
          )
        )
      );
    } else {
...
var ResourceUpload = React.createClass({displayName: "ResourceUpload",
                        ...
                        React.createElement("div", {className: "row"}, 
                            React.createElement("div", {className: "col s6 "}, 
                                React.createElement("div", {className: "input-field col s12"}, 
                                    ...
                                    React.createElement("input", {id: "icon_prefix", type: "text", className: "validate", ref: "resource_name"}), 
                                    React.createElement("label", {for: "icon_prefix"}, "Document Name")
                                )
                            ), 
                            React.createElement("div", {className: "col s6"}, 
                                React.createElement("div", {className: "input-field col s12"}, 
                                    React.createElement("i", {className: "material-icons prefix"}, "account_circle"), 
                                    React.createElement("input", {id: "icon_prefix", type: "text", className: "validate", ref: "course"}), 
                                    React.createElement("label", {for: "icon_prefix"}, "Course Name")
                                )
                            )
                        ), 
                        React.createElement("div", {className: "row"}, 
                            ...
                            React.createElement("div", {className: "col s6"}, 
                                React.createElement("div", {className: "input-field col s12"}, 
                                    React.createElement("select", {ref: "dept"}, 
                                        departmentOptions
                                    ), 
                            ...
                            React.createElement("div", {className: "col s6"}, 
                                React.createElement("div", {className: "input-field col s12"}, 
                                    React.createElement("select", {ref: "faculty"}, 
                                        facultyOptions
                                    ), 
...
var TestPhoto = React.createClass({displayName: "TestPhoto",
    getInitialState: function () {
        return {
            liked: false,
            count: 1
    ...
    render: function () {
        ...
        return (
            React.createElement("div", null, 
                ...
                React.createElement("p", {onClick: this.btnHandle}, btnText)
        ...
        return (
            ...
            React.createElement("div", {className: "row"}, 
                React.createElement("div", {className: "input-field col s6"}, 
                    ...
                    React.createElement("label", {htmlFor: "textarea1"}, this.props.children)
                )
            )
        );
    }
...
var TableComponent = React.createClass({displayName: "TableComponent",
    ...
    render: function () {
        ...
        var table_column = this.props.table_data.map(function (items) {
            ...
            return React.createElement(TableColumnData, {columnData: data})
        })
        return (
            React.createElement("table", null, 
                React.createElement(TableHeader, {tableheader_data: this.props.header_data}), 
...
var TableHeaderComponent = React.createClass({displayName: "TableHeaderComponent",
    ...
    render: function () {
        var th = this.props.tableheader_data.map(function (item, key) {
            return (
                ...
                React.createElement("th", {"data-field": item, key: key}, item)
